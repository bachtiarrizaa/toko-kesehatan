...
<section class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-14 mx-auto lg:py-14">
        <div class="lg:flex">
            ...
            <div class="mt-8 lg:w-1/2 lg:mt-0">
                <form class="w-full lg:max-w-xl" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="relative flex items-center mt-4">
                        <span class="absolute">
                            <ion-icon name="calendar-number-outline" class="w-6 h-6 mx-3 mt-2 text-gray-300 dark:text-gray-500"></ion-icon>
                        </span>
                    ...
                    <div class="relative flex items-center mt-4">
                        <span class="absolute">
                            <ion-icon name="people-outline" class="w-6 h-6 mx-3 mt-2 text-gray-300 dark:text-gray-500"></ion-icon>
                        </span>
                    
                        <select name="gender" id="gender" required
                            class="block w-full py-3 pl-11 pr-4 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40">
                    ...
                    <div class="relative flex items-center mt-4">
                        <span class="absolute">
                            <ion-icon name="navigate-circle-outline" class="w-6 h-6 mx-3 mt-2 text-gray-300 dark:text-gray-500"></ion-icon>
                        </span>
                    ...
                    <div class="relative flex items-center mt-4">
                        <span class="absolute">
                            <ion-icon name="call-outline" class="w-6 h-6 mx-3 mt-2 text-gray-300 dark:text-gray-500"></ion-icon>
                        </span>
                    ...
                    <div class="relative flex items-center mt-4">
                        <span class="absolute">
                            <ion-icon name="logo-paypal" class="w-6 h-6 mx-3 mt-2 text-gray-300 dark:text-gray-500"></ion-icon>
                        </span>
                    ...
                    <div class="relative flex items-center mt-4">
                        <span class="absolute">
                            <ion-icon name="location-outline" class="w-6 h-6 mx-3 mt-2 text-gray-300 dark:text-gray-500"></ion-icon>
                        </span>
                    ...
                    <div class="relative flex items-center mt-4">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" class="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Confirm Password" required>
                    </div>

                    <div class="mt-8 md:flex md:items-center md:justify-center">
                        <button type="submit" class="w-full md:w-1/2 px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-primary-700 rounded-lg hover:bg-primary-400 focus:outline-none focus:ring focus:ring-primary-300 focus:ring-opacity-50">
                            Sign Up
                        </button>
                    </div>
        ...
        <div class="mt-4 md:mt-20 sm:flex sm:items-center">
            <h3 class="text-primary-700 dark:text-primary-700 sm:w-1/2">Social networks</h3>

            <div class="flex items-center mt-4 sm:mt-0 -mx-1.5 sm:w-1/2">
                <a class="mx-1.5 dark:hover:text-primary-700 text-gray-400 transition-colors duration-300 transform hover:text-primary-500" href="#">
