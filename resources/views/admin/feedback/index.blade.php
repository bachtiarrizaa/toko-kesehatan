                                    ...
                                    <tbody>
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                            ...
                                            <td class="px-6 py-4 w-44">
                                                <a href="{{ route('admin.feedback.edit', $feedback->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline mr-4">
                                                    Edit
                                                </a>
                                                <form action="{{ route('admin.feedback.destroy', $feedback->id) }}) }}" method="POST" onsubmit="return confirm('Are you sure to remove this item?');">
                                                    @csrf
                                                    @method('DELETE')
