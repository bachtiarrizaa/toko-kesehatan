    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
        ...
        <div class="flex items-center space-x-4">
          ...
          <button id="sortDropdownButton1" data-dropdown-toggle="categoryDropdown" type="button"
            class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-grey dark:focus:ring-gray-700 sm:w-auto">
          ...
          <div id="categoryDropdown" class="z-50 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700" data-popper-placement="bottom">
