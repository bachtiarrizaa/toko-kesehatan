                ...
                <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                    ...
                    <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
                      @if($order->status === 'pending')
                          <a href="{{ route('order.success', $order->id) }}" class="text-blue-600 hover:text-blue-800 mr-8">View</a>
                                        ...
                                        <div class="col-span-2">
                                          ...
                                          <div class="col-span-2">
                                            <div class="col-span-2 sm:col-span-1">
                                              ...
                                              <input type="number" name="rating" id="rating" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Rating you're product" required="">
                                            </div>
                                          </div>
                                      </div>
